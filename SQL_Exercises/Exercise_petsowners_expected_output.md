...
8. Do owners name their pets after themselves? If so, who are they? Find their names! Hint: [Use INNER JOIN](https://www.postgresql.org/docs/8.3/tutorial-join.html)
